  ...
  Na.Chart = (function() {
    ...
    p.prototype._plotAreaMouseMove = function(a, d) {
      if (this.isDrag && 'none' !== this.plotInfo.axisPlacement) {
        ...
        (this.toolTip.mouseMoveHandler(a, d), 'none' !== this.plotInfo.axisPlacement)
      ) {
        if (this.axisX && 0 < this.axisX.length)
          ...
          if (0 < B.length)
            for (var p = 5 < q && f.bevelEnabled ? !0 : !1, g = 0; g < B.length; g++)
              if (
                ...
                c = N(c);
                r &&
                  ea(this._eventManager.ghostCtx, m, l, k, t, c, 0, null, !1, !1, !1, !1);
                (B[g].indexLabel ||
                  f.indexLabel ||
          ...
          if (0 < t.length) {
            ...
            for (h = 0; h < t.length; h++)
              if (
                ...
                c = N(c);
                r &&
                  ea(this._eventManager.ghostCtx, x, q, v, y, c, 0, null, !1, !1, !1, !1);
                (t[h].indexLabel ||
                  p.indexLabel ||
          ...
          if (0 < B.length) {
            ...
            for (g = 0; g < B.length; g++)
              if (
                ...
                c = N(c);
                r &&
                  ea(this._eventManager.ghostCtx, t, l, m, p, c, 0, null, !1, !1, !1, !1);
                (B[g].indexLabel ||
                  f.indexLabel ||
                  B[g].indexLabelFormatter ||
                  f.indexLabelFormatter) &&
          ...
          if (0 < t.length) {
            ...
            for (h = 0; h < t.length; h++)
              if (
                ...
                c = N(c);
                r &&
                  ea(this._eventManager.ghostCtx, y, x, s, v, c, 0, null, !1, !1, !1, !1);
                (t[h].indexLabel ||
                  k.indexLabel ||
                  t[h].indexLabelFormatter ||
                  k.indexLabelFormatter) &&
          ...
          if (0 < t.length) {
            ...
            for (h = 0; h < t.length; h++)
              if (
                ...
                c = N(c);
                r &&
                  ea(this._eventManager.ghostCtx, x, v, s, y, c, 0, null, !1, !1, !1, !1);
                (t[h].indexLabel ||
                  p.indexLabel ||
                  t[h].indexLabelFormatter ||
                  p.indexLabelFormatter) &&
    ...
    p.prototype.renderSplineArea = function(a) {
      function d() {
        ...
        if (0 < b.length) {
          ...
          c.globalAlpha = 1;
          r &&
            (e.lineTo(b[b.length - 1].x, t), e.lineTo(u.x, t), e.closePath(), e.fill());
        }
      }
      var b = a.targetCanvasCtx || this.plotArea.ctx,
        c = r ? this._preRenderCtx : b;
          ...
          if (0 < f.length)
            for (var k = 5 < h && n.bevelEnabled ? !0 : !1, g = 0; g < f.length; g++)
              if (
                ...
                c = N(t);
                r &&
                  ea(this._eventManager.ghostCtx, p, m, v, l, c, 0, null, !1, !1, !1, !1);
                if (
                  f[g].indexLabel ||
                  n.indexLabel ||
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
          ...
          l = this.options.dataPointMaxWidth
            ...
            ? this.dataPointWidth
            : c
            ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (A ? v : 1))) <<
              0
            : 0.3 * this.width;
          g &&
            (l = this.options.dataPointMaxWidth
          ...
          if (0 < k.length) {
            ...
            for (g = 0; g < k.length; g++)
              if (
                ...
                c = N(c);
                r &&
                  ea(this._eventManager.ghostCtx, m, w, l, v, c, 0, null, !1, !1, !1, !1);
                if (
                  k[g].indexLabel ||
                  f.indexLabel ||
          ...
          if (0 < v.length)
            for (
              ...
              if (
                ...
                e = N(e);
                r &&
                  ea(this._eventManager.ghostCtx, l, k, F, h, e, 0, null, !1, !1, !1, !1);
                var Y,
                  T = l;
                Y =
      ...
      function g(a, b, d) {
        ...
        if (0 <= a && a < s.length) {
          ...
          for (l = 1; l < s.length; l++)
            if (
              ((h = (a - l + f.length) % f.length), f[h].hemisphere !== f[a].hemisphere)
            ) {
              h = null;
              break;
            } else if (
    ...
    H.prototype.setLayout = function() {
      ...
      if (0 < k.length) {
        ...
        for (s = 0; s < k.length; s++) {
          ...
          if (
            !(0 >= m || 'undefined' === typeof m || 0 >= v || 'undefined' === typeof v)
          ) {
                    ...
                    if (u(this.options.labelWrap))
                      if (!u(this.options.labelMaxWidth))
                        ...
                        if (
                          ...
                          ((0 === v &&
                            n +
                              this._labels[v + 1].textBlock.measureText().width -
                              2 * g >
                              q) ||
                  ...
                  : ((this.sessionVariables.labelAngle = this.labelAngle),
                    (this.sessionVariables.labelMaxWidth =
                      0 === this.labelAngle
                        ...
                        : Math.min(
                            (c -
                              m * Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))) /
                              Math.cos((Math.PI / 180) * Math.abs(this.labelAngle)),
                            m
                          )),
                    u(this.options.labelWrap))
    ...
    z.prototype.createLabelsAndCalculateWidth = function() {
      ...
      return (c =
        'inside' === this.labelPlacement ? (c = d + b) : d + a + this.tickLength + b);
    };
    z.prototype.createLabelsAndCalculateHeight = function() {
      ...
      d = this.title ? this._titleTextBlock.measureText().height + 2 : 0;
      return (b =
        'inside' === this.labelPlacement ? (b = d + c) : d + a + this.tickLength + c);
    };
    ...
    z.render = function(a, d, b, c, e) {
      ...
      d[0] &&
        e.rect(5, d[d.length - 1].bounds.y1, d[0].chart.width - 10, d[0].bounds.height);
      e.clip();
      if (a && 0 < a.length)
    ...
    z.prototype.renderAxisLine = function() {
      ...
      if ('bottom' === this._position || 'top' === this._position) {
        ...
        if (this.scaleBreaks && !u(this.scaleBreaks.firstBreakIndex))
          if (u(this.scaleBreaks.lastBreakIndex))
            e =
              this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel +
              b;
          else
            for (
    ...
    z.prototype.calculateLogarithmicAxisParameters = function() {
      ...
      'axisX' === this.type
        ...
        : 'axisY' === this.type &&
          ...
          0 >= c && !isFinite(e)
            ? ((e =
                'undefined' === typeof this.options.interval ? 0 : this.options.interval),
              (c = 1))
            : 0 >= c
            ? (c = e)
            : isFinite(e) || (e = c),
  ...
  (function() {
    ...
    function G(a) {
      ...
      if ('#' == a.charAt(0)) b = a;
        ...
        for (var g, e = 0; 3 > e; e++)
          (g =
            -1 != c[e].indexOf('%') ? Math.floor(255 * (parseFloat(c[e]) / 100)) : +c[e]),
            (b += v[E(g, 0, 255)]);
        c = +c[3];
      } else if (/^hsl/.test(a)) {
        e = c = Q(a);
    ...
    d.quadraticCurveTo = function(a, b, c, g) {
      ...
      R(
        this,
        g,
        { x: g.x + (c.x - this.currentX_) / 3, y: g.y + (c.y - this.currentY_) / 3 },
        c
      );
    };
